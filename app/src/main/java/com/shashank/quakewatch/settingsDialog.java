...
public class settingsDialog extends DialogFragment {
    ...
    public interface onSetListener {
        void sendTheme(String theme, String mapTheme, boolean mThemeReset);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.settings_dialogue, container, false);
        ...
        if (getDialog() != null && getDialog().getWindow() != null) {
            ...
            if (nightModeFlags == Configuration.UI_MODE_NIGHT_NO) {
                ...
                settings_back.setColor(ContextCompat.getColor(getContext(), R.color.white));
            }
        ...
        rg_2.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            mOnSetListener.sendTheme(checked_button.getText().toString(), checked_button_2.getText().toString(), mThemeReset);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            mOnSetListener = (settingsDialog.onSetListener) getActivity();
